    ...
    @include('admin.includes.sidebar')
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Employee Designations</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <a class="btn btn-lg btn-success" href="{{route('designation.create')}}">Assign designation</a>
                    </div>
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Current List</h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form id="delete-form-{{$designation->id}}" action="{{route('designation.delete',$designation->id)}}" method="put">
                                                    @csrf
                                                    @method('DELETE')
                                                       <a href="{{route('designation.edit',$designation->id)}}" class="btn btn-sm btn-info">Edit</a>
