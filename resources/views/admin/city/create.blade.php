                        ...
                        <form action="{{route('city.store')}}" method="post" class="form-horizontal">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="city_name" class="form-control" id="fname" placeholder="Enter a City name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lname" class="col-sm-3 text-right control-label col-form-label">Zip code</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="zip_code" class="form-control" id="lname" placeholder="Enter zip code">
                                    </div>
                                </div>
                            </div>
